...
// 4. Inicialización de la Elección B en el registro con descripción (Corregido a 2 parámetros) 🌟
await identityRegistry.connect(admin).addClaimTopic(TOPIC_B, "Eleccion de Rectorado");
...
await expect(
identityRegistry.connect(admin).addClaimTopic(TOPIC_A, "Duplicado")
...
// =========================================================================
// BLOQUE 2: PRUEBAS EN VOTINGAPP.SOL
// =========================================================================
...
it("Validación 13: Debería revertir si se consulta un ID de candidato inexistente en getCandidate", async function () {
await expect(
      votingApp.getCandidate(TOPIC_A, 999n) // El ID 999 no existe, forzando la ejecución
    ).to.be.revertedWith("El candidato seleccionado no existe en esa eleccion"); // Ajustado a tu require exacto
});

it("Validación 14: Debería permitir al Administrador actualizar el Registro de Identidad en caliente", async function () {
// Dirección ficticia de prueba (0x000...123)
const nuevaDireccionIdentidad = "0x0000000000000000000000000000000000000123";
